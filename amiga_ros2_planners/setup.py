...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "move_to_openloop = amiga_ros2_planners.move_to_openloop_node:main",
            "sample_service = amiga_ros2_planners.sample_service_node:main",
            "tool_action = amiga_ros2_planners.tool_action_node:main",
